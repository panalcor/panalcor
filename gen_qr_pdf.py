...
MAQUINAS = [
  ...
  {'id':'MAQ-119','n':'TOLVA 1','t':'SILOS HARINA','f':'DAMM-SABATECNO','a':'OBRADOR'},
  {'id':'MAQ-120','n':'TOLVA 2','t':'SILOS HARINA','f':'DAMM-SABATECNO','a':'OBRADOR'},
  {'id':'MAQ-121','n':'TOLVA 3','t':'SILOS HARINA','f':'DAMM-SABATECNO','a':'OBRADOR'},
  {'id':'MAQ-122','n':'TOLVA 4','t':'SILOS HARINA','f':'DAMM-SABATECNO','a':'OBRADOR'},
  {'id':'MAQ-123','n':'TOLVA 5','t':'SILOS HARINA','f':'DAMM-SABATECNO','a':'OBRADOR'},
  {'id':'MAQ-124','n':'TOLVA 6','t':'SILOS HARINA','f':'DAMM-SABATECNO','a':'OBRADOR'},
  {'id':'MAQ-125','n':'TOLVA 7','t':'SILOS HARINA','f':'DAMM-SABATECNO','a':'OBRADOR'},
  ...
  {'id':'MAQ-151','n':'PRECINTADORA RELAMPAGO','t':'PRECINTADORA','f':'','a':'ENVASADO'},
  {'id':'MAQ-152','n':'PRECINTADORA TRUENO','t':'PRECINTADORA','f':'','a':'ENVASADO'},
  {'id':'MAQ-153','n':'COMPRESOR AIRE 75CV','t':'COMPRESORES','f':'','a':'COMPRESORES'},
  {'id':'MAQ-154','n':'COMPRESOR 1','t':'COMPRESORES','f':'','a':'COMPRESORES'},
  {'id':'MAQ-155','n':'COMPRESOR 2','t':'COMPRESORES','f':'','a':'COMPRESORES'},
  {'id':'MAQ-156','n':'COMPRESOR 3 TRUENO','t':'COMPRESORES','f':'','a':'COMPRESORES'},
